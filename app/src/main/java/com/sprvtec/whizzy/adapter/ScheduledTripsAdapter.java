...
import com.sprvtec.whizzy.ui.ScheduleTripDetailsActivity;
 ...
 */
public class ScheduledTripsAdapter extends BaseAdapter {
    ...
    public ScheduledTripsAdapter(Context context, List<Order> filteredData) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        mViewHolder.date.setText(order.scheduled_date_time);
